...
<body class="bg-gradient-to-br from-blue-400 via-blue-300 to-blue-500 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent">Create Admin Account</h1>
        ...
        <p class="text-center text-gray-600 text-sm mt-6">
            Already have an account? <a href="{{ route('admin.login') }}" class="text-blue-600 hover:text-blue-700 font-medium">Sign In</a>
        </p>
