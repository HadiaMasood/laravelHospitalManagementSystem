...
<head>
    ...
    <title>Cashier Registration - Hospital Management</title>
...
<body class="bg-gradient-to-br from-pink-400 via-pink-300 to-pink-500 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold bg-gradient-to-r from-pink-600 to-pink-700 bg-clip-text text-transparent">Create Cashier Account</h1>
        ...
        <form action="{{ route('cashier.register.post') }}" method="POST" class="space-y-4">
            @csrf
        ...
        <p class="text-center text-gray-600 text-sm mt-6">
            Already have an account? <a href="{{ route('cashier.login') }}" class="text-pink-600 hover:text-pink-700 font-medium">Sign In</a>
        </p>
